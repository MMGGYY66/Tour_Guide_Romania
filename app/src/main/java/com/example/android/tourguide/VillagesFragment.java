...
public class VillagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attractions.add(new Attraction(R.string.transylvania, R.string.transylvania_description, R.drawable.traditional_village_jina));
        ...
        AttractionAdapter adapter = new AttractionAdapter(getActivity(), attractions, R.color.category_villages);
